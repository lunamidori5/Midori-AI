...
while True:
    ...
    print("")
    print(Fore.RED + 'DEV NOTE' + Fore.WHITE + ': Be ready to run a repair of the subsystem.')
    print(Fore.RED + 'DEV NOTE' + Fore.WHITE + ': Changes happening in 24.4.15.0 will need to have you repair the subsystem.')
    print(Fore.RED + 'DEV NOTE' + Fore.WHITE + ': Type ``1`` and then follow what it askes you (you only have to do this once)')
    print("")
